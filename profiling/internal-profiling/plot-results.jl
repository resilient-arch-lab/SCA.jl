...
function plot_A5000_results_pub()
    ...
    for order in [2, 4, 8, 16, 32, 64]
        ...
        p = @df result_selection plot(
            ...
            xlims=(1e2-10, 1e3+100), ylims=(1e-2, 1e3),
            title="order=$(order)",
        )
        push!(plots, p)
    end
    ...
    savefig("profiling/internal-profiling/publication/A5000-non-atomic-time-scatter.png")
    ...
    savefig("profiling/internal-profiling/publication/A5000-non-atomic-time-scatter-3.png")
    ...
    savefig("profiling/internal-profiling/publication/A5000-non-atomic-time-scatter-3-3D.png")
end